...
public class Detail_Yogiyo extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yogiyo_recommendation);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.yogiyo.co.kr/mobile/superclub.html")));
            }
        });
    }
    ...
    public void drawLineChart(){
        LineChart lineChart = (LineChart) findViewById(R.id.linechart_activity_yogoyo_recommendation);
        ...
        //여기서 금액 넣기!
        entry_chart.add(new BarEntry(1,120000));
        entry_chart.add(new BarEntry(3,150000));
        entry_chart.add(new BarEntry(5,111000));
        entry_chart.add(new BarEntry(7,142000));

        LineData lineData = new LineData();

        LineDataSet lineDataSet = new LineDataSet(entry_chart, "음식 배달 관련 지출");
    ...
    public void drawBarChart() {
        BarChart barChart = (BarChart) findViewById(R.id.barchart_activity_yogiyo_recommendation);
        ...
        //여기서 금액 넣기!
        entry_chart.add(new BarEntry(0,142000));
        entry_chart.add(new BarEntry(1,133000));
