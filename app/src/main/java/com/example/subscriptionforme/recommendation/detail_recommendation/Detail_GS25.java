...
public class Detail_GS25 extends AppCompatActivity {
    ...
    public void drawLineChart(){
        LineChart lineChart = (LineChart) findViewById(R.id.linechart_activity_gs25_recommendation);
        ...
        //여기서 금액 넣기!
        entry_chart.add(new BarEntry(1,187000));
        entry_chart.add(new BarEntry(3,230100));
        entry_chart.add(new BarEntry(5,150200));
        entry_chart.add(new BarEntry(7,202500));

        LineData lineData = new LineData();

        LineDataSet lineDataSet = new LineDataSet(entry_chart, "gs25 편의점 관련 지출");
    ...
    public void drawBarChart() {
        BarChart barChart = (BarChart) findViewById(R.id.barchart_activity_gs25_recommendation);
        ...
        //여기서 금액 넣기!
        entry_chart.add(new BarEntry(0,202500));
        entry_chart.add(new BarEntry(1,151800));
