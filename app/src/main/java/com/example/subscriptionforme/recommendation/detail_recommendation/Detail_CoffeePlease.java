...
public class Detail_CoffeePlease extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coffeeplease_recommendation);
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.coffeeplease.co.kr/subscription.html")));
            }
        });
    }
    ...
    public void drawLineChart(){
        LineChart lineChart = (LineChart) findViewById(R.id.linechart_activity_coffee_recommendation);
        ...
        //여기서 금액 넣기!
        entry_chart.add(new BarEntry(1,21000));
        entry_chart.add(new BarEntry(3,48000));
        entry_chart.add(new BarEntry(5,25000));
        entry_chart.add(new BarEntry(7,36900));

        LineData lineData = new LineData();

        LineDataSet lineDataSet = new LineDataSet(entry_chart, "커피 관련 지출");
    ...
    public void drawBarChart() {
        BarChart barChart = (BarChart) findViewById(R.id.barchart_activity_coffee_recommendation);
        ...
        //여기서 금액 넣기!
        entry_chart.add(new BarEntry(0,36900));
        entry_chart.add(new BarEntry(1,30800));
