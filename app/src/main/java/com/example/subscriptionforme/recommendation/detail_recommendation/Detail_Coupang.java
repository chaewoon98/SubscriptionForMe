...
public class Detail_Coupang extends AppCompatActivity {
    ...
    public void drawLineChart(){
        LineChart lineChart = (LineChart) findViewById(R.id.linechart_activity_coupang_recommendation);
        ...
        //여기서 금액 넣기!
        entry_chart.add(new BarEntry(1,135000));
        entry_chart.add(new BarEntry(3,44500));
        entry_chart.add(new BarEntry(5,118000));
        entry_chart.add(new BarEntry(7,83300));

        LineData lineData = new LineData();

        LineDataSet lineDataSet = new LineDataSet(entry_chart, "쿠팡 관련 지출");
    ...
    public void drawBarChart() {
        BarChart barChart = (BarChart) findViewById(R.id.barchart_activity_coupang_recommendation);
        ...
        //여기서 금액 넣기!
        entry_chart.add(new BarEntry(0,83300));
        entry_chart.add(new BarEntry(1,70800));
