...
public class Detail_SmileClub extends AppCompatActivity {
    ...
    public void drawLineChart(){
        LineChart lineChart = (LineChart) findViewById(R.id.linechart_activity_smileclub_recommendation);
        ...
        //여기서 금액 넣기!
        entry_chart.add(new BarEntry(1,160000));
        entry_chart.add(new BarEntry(3,114000));
        entry_chart.add(new BarEntry(5,85000));
        entry_chart.add(new BarEntry(7,127000));

        LineData lineData = new LineData();

        LineDataSet lineDataSet = new LineDataSet(entry_chart, "옥션,G마켓,G9 관련 지출");
    ...
    public void drawBarChart() {
        BarChart barChart = (BarChart) findViewById(R.id.barchart_activity_smileclub_recommendation);
        ...
        //여기서 금액 넣기!
        entry_chart.add(new BarEntry(0,127000));
        entry_chart.add(new BarEntry(1,82500));
