...
public class AccountGetDataActivity extends AppCompatActivity {
    ...
    public void setAccountCoffeeList() {
        ...
        accountList.add(accountV28);
        AccountVO accountVO29 = new AccountVO("20200828", "131020", "4100", "0", "박태순", "", "스타벅스 군자점", "597800");
        accountList.add(accountVO29);
        AccountVO accountVO30 = new AccountVO("20200830", "134321","4100","0","박태순","","스타벅스 군자점","593700");
        accountList.add(accountVO30);
